                      ...
                      children: [
                        ...
                        StreamBuilder<List<LessonsRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<LessonsRecord>
                                lessonsComponentLessonsRecordList =
                                snapshot.data!;
                            // Return an empty Container when the item does not exist.
                            if (snapshot.data!.isEmpty) {
                              return Container();
                            }
                            final lessonsComponentLessonsRecord =
                                lessonsComponentLessonsRecordList.isNotEmpty
                                    ? lessonsComponentLessonsRecordList.first
                                    : null;
                            return wrapWithModel(
                              model: _model.lessonsComponentModel,
                              updateCallback: () => setState(() {}),
                              child: LessonsComponentWidget(
                                parameter1: containerCoursesRecord.courseTitle,
                                parameter2: 0,
                                parameter3: widget.courseRef,
                              ),
                            );
                          },
                        ),
