        ...
        body: SafeArea(
          ...
          child: FutureBuilder<List<ProfilesRow>>(
            ...
            builder: (context, snapshot) {
              ...
              List<ProfilesRow> stackProfilesRowList = snapshot.data!;
              final stackProfilesRow = stackProfilesRowList.isNotEmpty
                ...
                children: [
                  Padding(
                    ...
                    child: FutureBuilder<List<SocialMediaRow>>(
                      future: SocialMediaTable().querySingleRow(
                        queryFn: (q) => q,
                      ),
                      builder: (context, snapshot) {
                        // Customize what your widget looks like when it's loading.
                        ...
                        List<SocialMediaRow> columnSocialMediaRowList =
                            snapshot.data!;
                        final columnSocialMediaRow =
                            columnSocialMediaRowList.isNotEmpty
                                ? columnSocialMediaRowList.first
                                : null;
                          ...
                          child: Column(
                            ...
                            children: [
                                    ...
                                    onPressed: () async {
                                      {
                                        ...
                                        try {
                                          ...
                                          selectedMedia =
                                            ...
                                            selectedUploadedFiles,
                                            storageFolderPath: 'profile-pics',
                                          );
                                          downloadUrls =
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 12.0, 0.0, 0.0),
                                    child: Text(
                                      '${stackProfilesRow?.money?.toString()}د.ع ',
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                                            fontFamily: 'Readex Pro',
                              ...
                              Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  if (isiOS && columnSocialMediaRow!.epayment!)
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 12.0, 0.0, 0.0),
                                      child: FFButtonWidget(
