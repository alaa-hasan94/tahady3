  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ProfilesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProfilesRow> payProfilesRowList = snapshot.data!;
        final payProfilesRow =
            payProfilesRowList.isNotEmpty ? payProfilesRowList.first : null;
                            ...
                            children: [
                              ...
                              FFButtonWidget(
                                onPressed: (_model.textController.text ==
                                    ...
                                    ? null
                                    : () async {
                                        if (columnCouponCodeRow?.id != null) {
                                          ...
                                          await ProfilesTable().update(
                                            data: {
                                              'money': functions.incrementMoney(
                                                  payProfilesRow!.money,
                                                  columnCouponCodeRow!.value!),
                                            },
                                            matchingRows: (rows) => rows.eq(
                                              'use-id',
                                              currentUserUid,
