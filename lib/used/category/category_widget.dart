  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<ProfilesRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ProfilesRow> categoryProfilesRowList = snapshot.data!;
        final categoryProfilesRow = categoryProfilesRowList.isNotEmpty
            ? categoryProfilesRowList.first
            : null;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
          ...
          body: SafeArea(
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  if (categoryProfilesRow!.admin ? true : false)
                    FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed(
                          'editCatecory',
