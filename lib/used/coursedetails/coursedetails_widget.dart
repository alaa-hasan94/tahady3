                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                if ((widget.course?.id !=
                                        widget.orders?.courseId) &&
                                    (widget.course?.coursePrice != 0.0))
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 0.0, 0.0, 12.0),
                                    child: Row(
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 12.0, 0.0, 0.0),
                                          child: Text(
                                            '${widget.course?.coursePrice?.toString()}د.ع ',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Readex Pro',
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 12.0, 0.0, 0.0),
                                          child: Text(
                                            '${columnProfilesRow?.money?.toString()}د.ع ',
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                                  fontFamily: 'Readex Pro',
                                ...
                                Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children: [
                                    if (columnProfilesRow?.admin ?? true)
                                      FFButtonWidget(
                                        onPressed: () async {
                                          context.pushNamed(
                                            'editCourse',
                                    ...
                                    if (widget.course?.id !=
                                      ...
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            if (columnProfilesRow!.money >=
                                                widget.course!.coursePrice!) {
                                              await ProfilesTable().update(
                                                data: {
                                                  'money': functions.minus(
                                                      columnProfilesRow!.money,
                                                      widget.course!
                                                          .coursePrice!),
                                                },
