...
class _Auth1WidgetState extends State<Auth1Widget>
  ...
  void initState() {
    ...
    _model.phoneupTextController ??= TextEditingController();
    _model.phoneupFocusNode ??= FocusNode();
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      keyboardType:
                                                          TextInputType.phone,
                                                      validator: _model
                                                          .phoneinTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                ),
                                                  ...
                                                  Container(
                                                    ...
                                                    child: TextFormField(
                                                      ...
                                                      keyboardType:
                                                          TextInputType.phone,
                                                      validator: _model
                                                          .phoneupTextControllerValidator
                                                          .asValidator(context),
                                                    ),
                                                  ),
                                                                ...
                                                                return WebViewAware(
                                                                  child:
                                                                    ...
                                                                    title: Text(
                                                                        'مسجل مسبقا'),
                                                                    content: Text(
                                                                        'لديك حساب مسبقا سجل دخول او اضغط على نسيت كلمة السر'),
                                                                    actions: [
                                                                      TextButton(
                                                                        onPressed:
                                                                            () =>
                                                      ...
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0),
                                                      child: Text(
                                                        'سيتم ارسال رمز التأكيد عن طريق الواتساب',
                                                        style:
                                                            FlutterFlowTheme.of(
                                                                    context)
                                                                .bodyMedium
