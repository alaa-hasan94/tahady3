...
class Tahady3SupabaseUser extends BaseAuthUser {
  Tahady3SupabaseUser(this.user);
  User? user;
...
Stream<BaseAuthUser> tahady3SupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = Tahady3SupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
