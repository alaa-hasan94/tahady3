...
class _EditCourseWidgetState extends State<EditCourseWidget> {
  ...
  void initState() {
    ...
    _model.descriptionTextController ??=
        TextEditingController(text: widget.course?.courseDiscription);
    _model.descriptionFocusNode ??= FocusNode();

    _model.lessonNameTextController ??= TextEditingController();
    _model.lessonNameFocusNode ??= FocusNode();

    _model.lessonNumberTextController ??= TextEditingController();
    ...
    _model.htmlTextController ??= TextEditingController();
    _model.htmlFocusNode ??= FocusNode();

    _model.lessonDescTextController ??= TextEditingController();
                  ...
                  Expanded(
                    child: Padding(
                      ...
                      child: FutureBuilder<List<CategoryRow>>(
                        future: CategoryTable().querySingleRow(
                          queryFn: (q) => q.eq(
                            'name',
                            _model.dropDowngatValue,
                          ),
                        ),
                        builder: (context, snapshot) {
                          ...
                          List<CategoryRow> scrollingColumnCategoryRowList =
                              snapshot.data!;
                          final scrollingColumnCategoryRow =
                              scrollingColumnCategoryRowList.isNotEmpty
                                  ? scrollingColumnCategoryRowList.first
                                  : null;
                                      ...
                                      child: Wrap(
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: FutureBuilder<
                                                List<TeachersRow>>(
                                              future: TeachersTable()
                                                  .querySingleRow(
                                                queryFn: (q) => q.eq(
                                                  'name',
                                                  _model.dropDownTeacherValue,
                                                ),
                                              ),
                                              builder: (context, snapshot) {
                                                // Customize what your widget looks like when it's loading.
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: FutureBuilder<
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          List<TeachersRow>
                                                              dropDownTeacherTeachersRowList =
                                                              snapshot.data!;
                                                          return FlutterFlowDropDown<
                                                              String>(
                                                            controller: _model
                                                                    .dropDownTeacherValueController ??=
                                                                FormFieldController<
                                                                    String>(
                                                              _model.dropDownTeacherValue ??=
                                                                  widget.course
                                                ...
                                                Padding(
                                                  ...
                                                  child: FutureBuilder<
                                                    ...
                                                    builder:
                                                      ...
                                                      List<CategoryRow>
                                                          dropDowngatCategoryRowList =
                                                          snapshot.data!;
                                                      return FlutterFlowDropDown<
                                                          String>(
                                                        controller: _model
                                                                .dropDowngatValueController ??=
                                                            FormFieldController<
                                                                String>(
                                                          _model.dropDowngatValue ??=
                                                              widget.course
                                        ...
                                        await CoursesTable().update(
                                          data: {
                                            'course-title': _model
                                                .productNameTextController1
                                                .text,
                                            'course-discription': _model
                                                .descriptionTextController.text,
                                            'course-price': double.tryParse(
                                                _model
                                                    .productNameTextController2
                                                    .text),
                                            'course-teacher': _model
                                                            .dropDownTeacherValue !=
                                                        null &&
                                                    _model.dropDownTeacherValue !=
                                                        ''
                                                ? _model.dropDownTeacherValue
                                                : widget.course?.courseTeacher,
                                            'category': _model
                                                            .dropDowngatValue !=
                                                        null &&
                                                    _model.dropDowngatValue !=
                                                        ''
                                                ? scrollingColumnCategoryRow?.id
                                                : widget.course?.category,
                                            'category-name': _model
                                                            .dropDowngatValue !=
                                                        null &&
                                                    _model.dropDowngatValue !=
                                                        ''
                                                ? scrollingColumnCategoryRow
                                                    ?.name
                                        ...
                                        child: TextFormField(
                                          ...
                                          cursorColor:
                                              FlutterFlowTheme.of(context)
                                                  .primary,
                                          validator: _model
                                              .lessonNameTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          ...
                                          cursorColor:
                                              FlutterFlowTheme.of(context)
                                                  .primary,
                                          validator: _model
                                              .lessonNumberTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                      Padding(
                                        ...
                                        child: TextFormField(
                                          ...
                                          cursorColor:
                                              FlutterFlowTheme.of(context)
                                                  .primary,
                                          validator: _model
                                              .lessonDescTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                      Padding(
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            await LessonsTable().insert({
                                              'name': _model
                                                  .lessonNameTextController
                                                  .text,
                                              'description': _model
                                                  .htmlTextController.text,
                                              'youtube': _model
                                                  .youtubeTextController.text,
                                              'course-id': widget.course?.id,
                                              'lesson-number': double.tryParse(
                                                  _model
                                                      .lessonNumberTextController
                                                      .text),
                                              'videoid': _model
                                                  .htmlTextController.text,
                                            });
